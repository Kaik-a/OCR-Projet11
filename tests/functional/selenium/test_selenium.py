...
class SeleniumBasedTestCase(LiveServerTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.binary = "/Applications/Applications/Firefox.app/Contents/" \
                      "MacOS/firefox-bin"
    ...
    def test_create_account(self):
        ...
        self.driver.find_element_by_id(
            "id_last_name"
        ).send_keys("test_selenium_last_name")

        self.driver.find_element_by_id(
            "id_first_name"
        ).send_keys("test_selenium_first_name")

        self.driver.find_element_by_id(
            "id_email"
        ).send_keys("test_selenium_email@test.com")

        self.driver.find_element_by_id(
            "id_password"
        ).send_keys("test_selenium_password")
